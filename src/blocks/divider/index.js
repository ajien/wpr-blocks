...
const FallbackStyles = withFallbackStyles( ( node, ownProps ) => {
	...
	return {
		...
		// fallbackshapeColor: shapeColor || ! computedStyles ? undefined : computedStyles.color,
 ...
 */
registerBlockType( 'wpr/divider-block', {
	...
	styles: [
		{ name: 'wedge', label: __( 'Wedge' ), isDefault: true },
		{ name: 'book', label: __( 'Book' ) },
		{ name: 'cloud', label: __( 'Cloud' ) },
	],
	/**
	 ...
	 */
	edit: compose( [
		withColors( 'backgroundColor', { shapeColor: 'color' } ),
		FallbackStyles,
	] )( editSection ),
